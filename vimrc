...
set hidden						" Pouvoir changer de buffer sans les fermer
...
highlight TabLine ctermbg=DarkGray
highlight TabLineFill ctermbg=Black
highlight TabLineActive ctermbg=Yellow
highlight Pmenu ctermfg=31 ctermbg=Black
highlight PmenuSel ctermfg=Cyan ctermbg=232 cterm=Bold
highlight WarningMsg ctermfg=Yellow ctermbg=None cterm=Bold
highlight Menu ctermbg=Yellow
highlight WildMenu ctermbg=Red

"Couleur du pointeur
if has("autocmd")
  au VimEnter * silent !echo -ne "\033]12;Red\007" 
